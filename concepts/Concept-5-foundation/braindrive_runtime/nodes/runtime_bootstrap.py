...
SKILL_TEMPLATES = {
    ...
    "interview/prompts/start.md": (
        "# Interview Skill\n\n"
        "Conduct a software/product requirements interview for a BrainDrive workspace.\n"
        "Folder always means a digital workspace directory, never a physical folder.\n"
        "Ask one concise, high-value question at a time.\n"
    ),
    "interview/prompts/continue.md": (
        "# Interview Skill\n\n"
        "Continue a software/product requirements interview for a BrainDrive workspace.\n"
        "Folder always means a digital workspace directory, never a physical folder.\n"
        "Ask one concise, high-value follow-up question at a time.\n"
    ),
    "interview/prompts/complete.md": (
        "# Interview Skill\n\n"
        "Summarize interview findings for a software/project workspace in BrainDrive.\n"
        "Folder always means a digital workspace directory, never a physical folder.\n"
    ),
            ...
            if target.exists():
                if filename.endswith("/skill.yaml"):
                    try:
                        ...
                        raw = ""
                    if "actions:" in raw and "operation:" not in raw:
