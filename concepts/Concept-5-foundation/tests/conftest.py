...
from braindrive_runtime.providers import ollama as provider_ollama
from braindrive_runtime.providers import openrouter as provider_openrouter
...
def mock_model_providers(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(provider_openrouter.request, "urlopen", _fake_urlopen)
    monkeypatch.setattr(provider_ollama.request, "urlopen", _fake_urlopen)
