...
from concept3.nodes.base import NodeContext, ProtocolNode
from concept3.persistence import Persistence
from concept3.protocol import http_post_json, make_error, validate_core
from concept3.service_registration import start_registration_loop
from concept3.state import WorkflowState
...
REGISTRATION_TOKEN = os.getenv("ROUTER_REGISTRATION_TOKEN", "concept3-dev-token")
...
NODE_MAP: Dict[str, Type[ProtocolNode]] = {
    ...
    "interview": InterviewWorkflowNode,
    "spec": SpecWorkflowNode,
    "plan": PlanWorkflowNode,
