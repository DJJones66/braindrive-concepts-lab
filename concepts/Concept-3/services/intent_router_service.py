...
from concept3.constants import E_NODE_UNAVAILABLE
from concept3.intent_router import IntentRouterNL
from concept3.protocol import http_get_json, http_post_json, make_error, validate_core
        ...
        try:
            if self.path == "/intent/route":
                ...
                if body is None:
                    ...
                    return
                self._send_json(200, INTENT_ROUTER.route_endpoint(body))
                return
