# Concept-3 Natural Language Test Walkthrough
...
| `start interview` | `workflow.interview.start` | `node.workflow.interview` |
| `answer: I want to help SMBs with AI automation` | `workflow.interview.continue` | `node.workflow.interview` |
| `complete interview` | `workflow.interview.complete` | `node.workflow.interview` |
| `generate spec` | `workflow.spec.generate` | `node.workflow.spec` |
| `save spec` | `workflow.spec.propose_save` | `node.workflow.spec` -> approval/write/commit flow |
| `generate plan` | `workflow.plan.generate` | `node.workflow.plan` |
| `save plan` | `workflow.plan.propose_save` | `node.workflow.plan` -> approval/write/commit flow |
...
1. Open a second terminal and run:
   - `tail -f /home/hacker/Projects/BrainDrive-Protocal/Concept_Containers/Concept-3/data/runtime/logs/router.jsonl`
