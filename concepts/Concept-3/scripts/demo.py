...
ROUTER_BASE = os.getenv("CONCEPT3_ROUTER_BASE", "http://localhost:9380")
INTENT_BASE = os.getenv("CONCEPT3_INTENT_BASE", "http://localhost:9381")
TIMEOUT_SEC = float(os.getenv("CONCEPT3_DEMO_TIMEOUT_SEC", "4.0"))
...
def main() -> None:
    ...
    print("Concept-3 docker compose demo checks passed.")
