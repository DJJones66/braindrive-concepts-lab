...
class CliClient:
    ...
    def _stream_headers_for_provider(self, provider: str) -> Dict[str, str]:
        ...
        if provider == "openrouter":
            ...
            app_name = _env("BRAINDRIVE_OPENROUTER_APP_NAME", default="BrainDrive Concept-4").strip()
            if app_name:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="BrainDrive Concept-4 terminal CLI")
