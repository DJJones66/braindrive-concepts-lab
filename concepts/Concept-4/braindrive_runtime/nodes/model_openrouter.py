...
class OpenRouterModelNode(ProtocolNode):
    ...
    def __init__(self, ctx) -> None:
        ...
        self.base_url = str(source_env.get("BRAINDRIVE_OPENROUTER_BASE_URL", "https://openrouter.ai/api/v1")).rstrip("/")
        self.api_key = str(source_env.get("BRAINDRIVE_OPENROUTER_API_KEY", "")).strip()
        self.site_url = str(source_env.get("BRAINDRIVE_OPENROUTER_SITE_URL", "")).strip()
        self.app_name = str(source_env.get("BRAINDRIVE_OPENROUTER_APP_NAME", "BrainDrive Concept-4")).strip()
    ...
    def capabilities(self) -> List:
        return [
            cap(
                ...
                description="Complete chat using OpenRouter provider",
            ...
            cap(
                ...
                description="Stream chat using OpenRouter provider",
                input_schema={"type": "object", "required": ["prompt"]},
                risk_class="read",
                required_extensions=[],
                approval_required=False,
    ...
    def handle(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        provider = str(llm.get("provider", "")).strip() or MODEL_PROVIDER_OPENROUTER
