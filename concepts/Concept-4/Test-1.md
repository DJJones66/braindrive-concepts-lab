# Concept-4 Natural Language Test Walkthrough
...
1. Open a second terminal and run:
   - `tail -f /home/hacker/Projects/BrainDrive-Protocal/Concept_Containers/Concept-4/data/runtime/logs/router.jsonl`
